            ...
            <div class="profile navbar-right">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="${pageContext.request.contextPath}/order/toorder"><c:if
                        ...
                        <c:if
                                test="${sessionScope.languageStatus eq '2'}">Preisgestaltung</c:if></a>
                    </li>
                    ...
                    <li role="presentation" class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button"
                           aria-haspopup="true" aria-expanded="false">
                            <c:if test="${sessionScope.languageStatus eq '2' }">Sprache</c:if>
                            <c:if test="${sessionScope.languageStatus eq '1' }">语言</c:if>
                            <c:if test="${sessionScope.languageStatus eq '0' }">Language</c:if>

                ...
                <div class="row ">
                    ...
                    <div class="row ">
                        ...
                        <div class="proj-title"><c:if
                            ...
                            <c:if
                                test="${sessionScope.languageStatus eq '0'|| sessionScope.languageStatus == null}">Big Data Project Development</c:if>
                            <c:if
                                test="${sessionScope.languageStatus eq '2'|| sessionScope.languageStatus == null}">Big Data Projektentwicklung</c:if></div>
                        </div>
                        <div class="col-md-6  col-xs-12">
                        ...
                        <div class="proj-title"><c:if
                            ...
                            <c:if
                                test="${sessionScope.languageStatus eq '2'|| sessionScope.languageStatus == null}">Die statistisches Analyseprojekt </c:if></div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6  col-xs-12">
                        ...
                        <div class="proj-title"><c:if
                            ...
                            <c:if
                                test="${sessionScope.languageStatus eq '0'|| sessionScope.languageStatus == null}">Wechat app group-buying Software</c:if>
                            <c:if
                                test="${sessionScope.languageStatus eq '2'|| sessionScope.languageStatus == null}">Wechat app Gruppenkaufsoftware</c:if></div>
                        </div>
                        <div class="col-md-6  col-xs-12">
                        ...
                        <div class="proj-title"><c:if
                            ...
                            <c:if
                                test="${sessionScope.languageStatus eq '0'|| sessionScope.languageStatus == null}">Group buying/ordering App</c:if>
                            <c:if
                                test="${sessionScope.languageStatus eq '2'|| sessionScope.languageStatus == null}">Gruppenkauf / Bestell-App</c:if></div>
                        </div>
                    </div>
                </div>
            </div>
